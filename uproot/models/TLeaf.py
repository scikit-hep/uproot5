...
class Model_TLeaf_v2(uproot.model.VersionedModel):
    """
    A :py:class:`~uproot.model.VersionedModel` for ``TLeaf`` version 2.
    """
...
class Model_TLeaf(uproot.model.DispatchByVersion):
    """
    A :py:class:`~uproot.model.DispatchByVersion` for ``TLeaf``.
    """
...
class Model_TLeafO_v1(uproot.model.VersionedModel):
    """
    A :py:class:`~uproot.model.VersionedModel` for ``TLeafO`` version 1
    (``numpy.bool_``).
    """
...
class Model_TLeafO(uproot.model.DispatchByVersion):
    """
    A :py:class:`~uproot.model.DispatchByVersion` for ``TLeafO`` (``numpy.bool_``).
    """
...
class Model_TLeafB_v1(uproot.model.VersionedModel):
    """
    A :py:class:`~uproot.model.VersionedModel` for ``TLeafB`` version 1
    (``numpy.int8``).
    """
...
class Model_TLeafB(uproot.model.DispatchByVersion):
    """
    A :py:class:`~uproot.model.DispatchByVersion` for ``TLeafB`` (``numpy.int8``).
    """
...
class Model_TLeafS_v1(uproot.model.VersionedModel):
    """
    A :py:class:`~uproot.model.VersionedModel` for ``TLeafS`` version 1
    (``numpy.int16``).
    """
...
class Model_TLeafS(uproot.model.DispatchByVersion):
    """
    A :py:class:`~uproot.model.DispatchByVersion` for ``TLeafS`` (``numpy.int16``).
    """
...
class Model_TLeafI_v1(uproot.model.VersionedModel):
    """
    A :py:class:`~uproot.model.VersionedModel` for ``TLeafI`` version 1
    (``numpy.int32``).
    """
...
class Model_TLeafI(uproot.model.DispatchByVersion):
    """
    A :py:class:`~uproot.model.DispatchByVersion` for ``TLeafI`` (``numpy.int32``).
    """
...
class Model_TLeafL_v1(uproot.model.VersionedModel):
    """
    A :py:class:`~uproot.model.VersionedModel` for ``TLeafL`` version 1
    (``numpy.int64``).
    """
...
class Model_TLeafL(uproot.model.DispatchByVersion):
    """
    A :py:class:`~uproot.model.DispatchByversion` for ``TLeafL`` (``numpy.int64``).
    """
...
class Model_TLeafF_v1(uproot.model.VersionedModel):
    """
    A :py:class:`~uproot.model.VersionedModel` for ``TLeafF`` version 1
    (``numpy.float32``).
    """
...
class Model_TLeafF(uproot.model.DispatchByVersion):
    """
    A :py:class:`~uproot.model.DispatchByVersion` for ``TLeafF`` (``numpy.float32``).
    """
...
class Model_TLeafD_v1(uproot.model.VersionedModel):
    """
    A :py:class:`~uproot.model.VersionedModel` for ``TLeafD`` version 1
    (``numpy.float64``).
    """
...
class Model_TLeafD(uproot.model.DispatchByVersion):
    """
    A :py:class:`~uproot.model.DispatchByVersion` for ``TLeafD`` (``numpy.float64``).
    """
...
class Model_TLeafC_v1(uproot.model.VersionedModel):
    """
    A :py:class:`~uproot.model.VersionedModel` for ``TLeafC`` version 1
...
class Model_TLeafC(uproot.model.DispatchByVersion):
    """
    A :py:class:`~uproot.model.DispatchByVersion` for ``TLeafC`` (variable-length
    strings).
    """
...
class Model_TLeafF16_v1(uproot.model.VersionedModel):
    """
    A :py:class:`~uproot.model.VersionedModel` for ``TLeafF16`` version 1
    (ROOT's ``Float16_t``).
    """
...
class Model_TLeafF16(uproot.model.DispatchByVersion):
    """
    A :py:class:`~uproot.model.DispatchByVersion` for ``TLeafF16`` (ROOT's
    ``Float16_t``).
    """
...
class Model_TLeafD32_v1(uproot.model.VersionedModel):
    """
    A :py:class:`~uproot.model.VersionedModel` for ``TLeafD32`` version 1
    (ROOT's ``Double32_t``).
    """
...
class Model_TLeafD32(uproot.model.DispatchByVersion):
    """
    A :py:class:`~uproot.model.DispatchByVersion` for ``TLeafD32`` (ROOT's
    ``Double32_t``).
    """
...
class Model_TLeafElement_v1(uproot.model.VersionedModel):
    """
    A :py:class:`~uproot.model.VersionedModel` for ``TLeafElement`` version 1
...
class Model_TLeafElement(uproot.model.DispatchByVersion):
    """
    A :py:class:`~uproot.model.DispatchByVersion` for ``TLeafElement``
    (arbitrary objects, associated with ``TBranchElement``).
    """
