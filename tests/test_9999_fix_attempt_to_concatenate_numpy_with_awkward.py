...
def test_partially_fix_issue_951(execution_number):
    ...
    with uproot.open("DAOD_PHYSLITE_24.0.2.art.pool.root:CollectionTree") as tree:
        ...
        for key, branch in tree.iteritems(filter_typename="*ElementLink*"):
            ...
            if key == 'METAssoc_AnalysisMETAux./METAssoc_AnalysisMETAux.jetLink' or 'EventInfoAuxDyn.hardScatterVertexLink/EventInfoAuxDyn.hardScatterVertexLink':
                pass
...
def test_fix_issue_1101():
    ...
    with uproot.open("root://xcache.af.uchicago.edu//root://xrootd.echo.stfc.ac.uk:1094/atlas:datadisk/rucio/mc23_13p6TeV/26/c7/DAOD_PHYSLITE.35010028._000001.pool.root.1") as f:
