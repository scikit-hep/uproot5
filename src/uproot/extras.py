...
or
    ...
    if parse_version(dask_awkward.__version__) >= parse_version("2023.9.4"):
        return dask_awkward
    else:
        raise ModuleNotFoundError(
            "Uproot 5.x can only be used with dask-awkward 2023.9.4 or newer; you have dask-awkward {}".format(
